        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
              ...
              <span class="hidden-xs">Helen Keller</span>
            </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> My Year </a></li>
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> My Courses </a></li>
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> My Subjects </a></li>
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> My Sections </a></li>
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> My Students </a></li>
          </ul>
        </li>
      </ul>
    </section>
