									...
									<?php foreach ($students->result() as $key => $value): ?>
										...
										<?php if ($value->status == 'active'): ?>
											...
											<?php elseif($value->status == 'locked'): ?>
												...
												<?php endif ?>
												<td>
													<?=$value->course_name?> <?=$value->stud_year_id?>-<?=$value->section_id?>
												</td>
												...
												<td>
													<!-- Update -->
													<a href="<?=base_url()?>Admin/Student/Edit/<?=$value->student_id?>" data-placement="left" title="Update" class="btn btn-sm btn-primary"><i class="mdi mdi-update"></i></a>
